...
SELECT dept_manager.emp_no, dept_manager.dept_no, departments.dept_name, employees.emp_no, employees.first_name, employees.last_name
FROM dept_manager
...
SELECT last_name, COUNT (*) AS name_counts
FROM employees
GROUP BY last_name
